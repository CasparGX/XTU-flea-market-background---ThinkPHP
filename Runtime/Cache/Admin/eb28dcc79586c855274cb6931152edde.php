...
<body>
				...
				<div class="trade-content" id="hot">
					...
					<ul>
						<?php if(is_array($goodsSelect)): foreach($goodsSelect as $k=>$vo): ?><li class="item">
								...
								<span style="background-color:#f82;float:left;position:absolute;z-index:1;margin-left:40px;" onclick="soldOut(<?php echo ($vo["id"]); ?>,this);">下架</span>
								<a href="####" class="a-img">
	...
	<script type="text/javascript">
		...
		function soldOut($id, obj) {
			$.ajax({
				url: "<?php echo U('Admin/Goods/soldOut',"","","");?>?id="+$id,
				type: "get",
				dataType: "json",
				success:function(data){
					if(data.result=="error") {
